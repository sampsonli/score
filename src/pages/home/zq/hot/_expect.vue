            ...
            <div class="qi-list">
                <ul class="responsive">
                    <li class="" v-if="preAndNextExpect.pre">
                        <router-link :to="{path: '/home/zq/hot/'+ preAndNextExpect.pre}" replace>前一期</router-link>
                    </li>
                    ...
                    <li class="" v-if="preAndNextExpect.next">
                        <router-link :to="{path: '/home/zq/hot/'+ preAndNextExpect.next}" replace>后一期</router-link>
                    </li>
